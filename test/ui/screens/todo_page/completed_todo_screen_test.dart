...
void main() {
  ...
  group('CompletedTodoScreen', () {
    ...
    Widget buildSubject({List<Todo> todos = const <Todo>[]}) {
      ...
      return CompletedTodoScreen();
    }

    testWidgets('renders CompletedTodoScreen', (tester) async {
    ...
    testWidgets(
      'renders completed todos',
        ...
        expect(find.descendant(
          ...
          matching: find.byWidgetPredicate((w) =>  w is Checkbox && w.value == false)
        ), findsNothing);
      },
    );
  });
